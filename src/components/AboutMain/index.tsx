  ...
  return (
    <Container>
      <section>
        ...
        <p>This project was mainly developed to learn concepts about infinite loading, such as infinite scroll and pagination.</p>
        <section>
      ...
      <section>
        ...
        <div>
          ...
          <a href="https://github.com/vitorqf/">
            <GithubLogo color='red' weight='bold' size={32}/>
          </a>
        </div>
      </section>
    </Container>
